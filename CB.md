...
Tradional ML is well-tested and easy to formulate, hence this was the first approach that was taken. After noting down the historical performance of the model, the team believed that their pricing stratergy could use some improvement. Efforts were to made to identify what other solutions can be used to solve this problem. 
...
I researched on the Contextual Bandit algorithm and understand how it can be used for this use-case. 
...
```
    ...
    [NbConvertApp] Writing 13406 bytes to /Users/amar96/Desktop/Ford/CB.md
